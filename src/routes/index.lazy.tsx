          ...
          <header className="bg-white shadow-sm">
            <div className="container mx-auto px-4 py-4 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button aria-label="Cart" className="text-gray-600 hover:text-gray-800">
          ...
          <main className="flex-grow">
            ...
            <section className="bg-gray-100 py-12 md:py-24">
              <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 mb-8 md:mb-0">
                  ...
                  <p className="text-xl mb-6">Discover the hottest trends for your summer wardrobe.</p>
                    ...
                    <Link key={category} to={`/category/${category.toLowerCase()}`} className="group">
                      <div className="relative aspect-square overflow-hidden rounded-lg">
                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                          <span className="text-white text-xl font-semibold capitalize">{category}</span>
                        </div>
                      </div>
                    </Link>
                  ))}
            ...
            <section className="py-12 bg-gray-800 text-white">
              <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-xl mb-6">Get 20% off on your first purchase. Use code: FIRST20</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link href="/bestsellers" className="text-gray-600 hover:text-gray-800">
                        Bestsellers
                      </Link>
                    </li>
                    <li>
                      <Link href="/sale" className="text-gray-600 hover:text-gray-800">
                        Sale
                      </Link>
                    </li>
                  </ul>
